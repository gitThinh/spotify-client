...
const HomePage = () => {
  ...
  const [tokens, setTokens] = useState(
    Cookies.get("Tokens") !== undefined ? JSON.parse(Cookies.get("Tokens")) : ""
  );
  ...
  // get rcm list
  useEffect(() => {
    (playingSong !== "") & isNewPlaying && setRcmList([]);
                ...
                {user !== "" ? (
                  <div className="info_user noone_coppy" ref={infoUser}>
                    <img
                      ...
                      onClick={() => {
                        const detailsUser =
                          document.querySelector(".info_user_table");
                    ...
                    />
                    <div
                      className="info_user_table"
                      style={{ display: "none" }}
                      ref={infoUserTable}
                    >
                      <ul>
                        <li>
                          <button className="info_user_table_option">
                            Profile
                          </button>
                        </li>
                        <li>
                        ...
                        <li>
                          <a href="/" className="info_user_table_option">
                            Support
                          </a>
                        </li>
                        <li>
                          <button
                            className="info_user_table_option"
